...
public class ServiceLocator extends org.apache.axis.client.Service implements com.comverse_in.prepaid.ccws.Service {
    ...
    private String ServiceSoap_address = "http://192.1.1.94/CCWS/ccws.asmx";
    ...
    public com.comverse_in.prepaid.ccws.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.comverse_in.prepaid.ccws.ServiceSoapStub _stub = new com.comverse_in.prepaid.ccws.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.comverse_in.prepaid.ccws.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.comverse_in.prepaid.ccws.ServiceSoapStub _stub = new com.comverse_in.prepaid.ccws.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://comverse-in.com/prepaid/ccws", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://comverse-in.com/prepaid/ccws", "ServiceSoap"));
        }
