...
public enum ReturnResultProblemType
{
    ...
    /**
     * Signifies that the type of parameter in the return result component is not that agreed by the two TC-Users.
     * This code is
    ...
    public static ReturnResultProblemType getFromInt(long t)
            throws
            ParseException
    {
        if (t == 0)
