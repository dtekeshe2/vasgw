...
public enum GeneralProblemType
{
    ...
    /**
     * The component type is not recognized as being one of those defined in 3.1. (Invoke, ReturnResult,
     * ReturnResultLast,
    ...
    /**
     * The elemental structure of a component does not conform to the structure of that component as defined in 3.1/Q
     * .773. This
    ...
    /**
     * The contents of the component do not conform to the encoding rules defined in 4.1/Q.773. This code is
     * generated by the
     * TCAP layer.
     */
    ...
    public static GeneralProblemType getFromInt(long t)
            throws
            ParseException
    {
        if (t == 0)
