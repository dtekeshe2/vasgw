...
/**
 * This class embeds Parameter/Parameters. It can be either primtiive or constructed. It supports two types of
 * encoding -
 * content as byte[] - either simple or complex - depends on how TC-User sets parameters, or content as Parameter[] -
 * in this
 ...
 * </li>
 * </ul>
 * Note that on read only byte[] is filled! In case TC-USER makes call to {@link #getParameters()} method - it
 * triggers parsing
        ...
        extends Encodable
{
    ...
    /**
     * Set a length that will be encoded when ASN.1 parameter encoding Usually this length is equal getData().length
     * and we need
     * not set this You can use this only when "encoded length value"!=getData().length If setEncodingLength() has
     * not been
