...
public enum PAbortCauseType
{
    ...
    /**
     * The transaction portion of the received message does not conform to the X.209 encoding rules as outlined in 4
     * .1/Q.773.
     */
    BadlyFormattedTxPortion(2),

    /**
     * The elemental structure within the transaction portion of the received message does not conform to the rules
     * for the
    ...
    /**
     * Sufficient resources are not available to start a transaction. Now it is limited by total active Dialogs count
     * <= max
     * possible
     */
    ...
    /**
     * - TC-Abort has been received with abortSourceType==Provider and no AbortSource is given - abnormal dialog
     * state for a
    ...
    public static PAbortCauseType getFromInt(int t)
            throws
            ParseException
    {
