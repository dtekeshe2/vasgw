 ...
 * <br/>
 * <p>
 * The DialogPortion consist of Dialogue Portion Tag (0x6B), Dialogue Portion Length; External Tag (0x28), External
 * Length;
 ...
 * <br/>
 * <p>
 * Object Identifier Tag (0x06), Object Identifier Length; Dialogue-as-ID value; Single-ASN.1-type Tag (0xa0),
 * Single-ASN.1-type
 * Length; Dialogue PDU
 * </p>
 * <br/>
 * <p>
 * As per the Table 37/Q.773 – Dialogue-As-ID Value is represented OID. Please look {@link DialogPortionImpl
 * ._DIALG_STRUCTURED}
 * </p>
 * <br/>
 * <p>
 ...
 * <br/>
 * <p>
 * As per the Table 36/Q.773 – Unidialogue-As-ID Value is represented as OID. Please look {@link DialogPortionImpl
 * ._DIALG_UNI}
 * </p>
 */
        ...
        implements DialogPortion
{
            ...
            EncodeException
    {
        ...
        try
        {
            ...
            {
                throw new EncodeException("No setUnidirectional() for DialogPortion is defined when encoding " +
                        "DialogPortion");
            }
    ...
    public void decode(AsnInputStream aisA)
            throws
            ParseException
    {
        ...
        {
            throw new ParseException(PAbortCauseType.BadlyFormattedTxPortion, null, "IOException when decoding " +
                    "DialogPortion: "
                    + e.getMessage(), e);
        }
        catch (AsnException e)
