        ...
        extends InputStream
{
    ...
    protected AsnInputStream(AsnInputStream buf, int start, int length)
            throws
            IOException
    {
     ...
     *
     * @param b   The byte array to be filled by data
     * @param off Offset of byte array from which fill the array
     * @param len Bytes count to fill
     ...
     * @throws IOException
     */
    public AsnInputStream readSequenceStream()
            throws
            AsnException,
            IOException
    {
     ...
     * @throws IOException
     */
    public AsnInputStream readSequenceStreamData(int length)
            throws
            AsnException,
            IOException
    {
     ...
     * @throws IOException
     */
    public byte[] readSequenceData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public AsnInputStream readSequenceIndefinite()
            throws
            AsnException,
            IOException
    {
    ...
    private void advanceIndefiniteLength()
            throws
            AsnException,
            IOException
    {
     ...
     * @throws AsnException
     */
    public void advanceElementData(int length)
            throws
            IOException,
            AsnException
    {
    ...
    public boolean readBooleanData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public long readIntegerData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public double readRealData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public BitSetStrictLength readBitString()
            throws
            AsnException,
            IOException
    {
    ...
    public BitSetStrictLength readBitStringData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void readBitString(BitSet bitSet)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void readBitStringData(BitSet bitSet, int length)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void readBitStringData(BitSet bitSet, int length, boolean isTagPrimitive)
            throws
            AsnException,
            IOException
    {
    ...
    private int _readBitString(BitSet bitSet, int length, int counter)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void readOctetString(OutputStream outputStream)
            throws
            AsnException,
            IOException
    {
    ...
    public byte[] readOctetStringData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void readOctetStringData(OutputStream outputStream, int length)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void readOctetStringData(
            OutputStream outputStream,
            int length,
            boolean isTagPrimitive)
            throws
            AsnException,
            IOException
    {
    ...
    private void _readOctetString(OutputStream outputStream, int length)
            throws
            AsnException,
            IOException
    {
...
//		int tagValue = this.readTag();
    ...
    public void readNullData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public long[] readObjectIdentifier()
            throws
            AsnException,
            IOException
    {
    ...
    public long[] readObjectIdentifierData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public String readIA5StringData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public String readUTF8StringData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    public String readGraphicString()
            throws
            AsnException,
            IOException
    {
    ...
    public String readGraphicStringData(int length)
            throws
            AsnException,
            IOException
    {
    ...
    private String readString(String charset, int tagValue, int length)
            throws
            IOException,
            AsnException
    {
