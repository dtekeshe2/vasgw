...
public class External
{
            ...
            while (true)
            {
                ...
                if (localAsnIS.getTagClass() == Tag.CLASS_UNIVERSAL)
                {
                    switch (tag)
                    {
                        ...
                        default:
                            throw new AsnException("Error while decoding External: Unrecognized tag value=" + tag +
                                    ", tagClass=" + localAsnIS.getTagClass());
                    }
    ...
    public void encode(AsnOutputStream aos, int tagClass, int tag)
            throws
            AsnException
    {
        ...
        if (!this.asn && !this.octet && !this.arbitrary)
            throw new AsnException("Error while encoding External: asn value, octect value or arbitrary value must be" +
					" definite");
