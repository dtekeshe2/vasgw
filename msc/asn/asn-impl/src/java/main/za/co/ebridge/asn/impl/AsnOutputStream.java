        ...
        extends OutputStream
{
     ...
     * @throws AsnException
     */
    public void writeTag(int tagClass, boolean primitive, int tag)
            throws
            AsnException
    {
...
//			this.buffer[posLen] = (byte) (count | 0x80);
     ...
     *
     * @param lenPos This parameter is the the return value of the
    ...
    public void writeSequence(byte[] data)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeSequence(int tagClass, int tag, byte[] data)
            throws
            IOException,
            AsnException
    {
    ...
    public int writeSequenceData(byte[] data)
            throws
            IOException,
            AsnException
    {
    ...
    public int writeBooleanData(boolean value)
            throws
            IOException
    {
    ...
    public void writeInteger(int tagClass, int tag, long v)
            throws
            IOException,
            AsnException
    {
    ...
    public int writeIntegerData(long v)
            throws
            IOException
    {
    ...
    public void writeReal(String d, int NR)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeReal(int tagClass, int tag, String d, int NR)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeReal(int tagClass, int tag, double d)
            throws
            IOException,
            AsnException
    {
    ...
    public int writeRealData(String d, int NR)
            throws
            AsnException,
    ...
    public int writeRealData(double d)
            throws
            AsnException,
            IOException
    {
    ...
    public void writeBitString(BitSetStrictLength bitString)
            throws
            AsnException,
            IOException
    {
    ...
    public void writeBitString(int tagClass, int tag, BitSetStrictLength bitString)
            throws
            AsnException,
            IOException
    {
    ...
    public int writeBitStringData(BitSetStrictLength bitString)
            throws
            AsnException,
            IOException
    {
...
//		}
    ...
    public void writeOctetString(int tagClass, int tag, byte[] value)
            throws
            IOException,
            AsnException
    {
    ...
    public int writeOctetStringData(byte[] value)
    {
        ...
        // enough for protocols.ss7.cap.api. For constructed encoding we should add another method
    ...
    @Deprecated
    public void writeStringOctet(int tagClass, int tag, InputStream io)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void writeStringOctet(InputStream io)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void writeStringOctetData(InputStream io)
            throws
            AsnException,
            IOException
    {
    ...
    public void writeObjectIdentifier(long[] oid)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeObjectIdentifier(int tagClass, int tag, long[] oid)
            throws
            IOException,
            AsnException
    {
    ...
    public int writeObjectIdentifierData(long[] oidLeafs)
            throws
            IOException
    {
    ...
    public void writeStringUTF8(int tagClass, int tag, String data)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeStringUTF8Data(String data)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeStringIA5(String data)
            throws
            AsnException,
            IOException
    {
    ...
    public void writeStringIA5(int tagClass, int tag, String data)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeStringIA5Data(String data)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeStringGraphic(String data)
            throws
            AsnException,
            IOException
    {
    ...
    public void writeStringGraphic(int tagClass, int tag, String data)
            throws
            IOException,
            AsnException
    {
    ...
    public void writeStringGraphicData(String data)
            throws
            IOException,
            AsnException
    {
    ...
    @Deprecated
    public void writeStringBinary(BitSet bitString)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void writeStringBinary(int tagClass, int tag, BitSet bitString)
            throws
            AsnException,
            IOException
    {
    ...
    @Deprecated
    public void writeStringBinaryData(BitSet bitString)
            throws
            AsnException,
            IOException
    {
