...
/**
 * The listener interface for receiving status update on M3UA resources.
 * The class that is interested in processing status update must implements this interface
 * and the object created with that class is registered with {@link M3UAManagement} using
