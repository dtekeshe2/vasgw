 ...
 * for example, a Heartbeat Sequence Number and/or Timestamp.
 * The receiver of a BEAT message does not process this field, as it is only of significance to the sender.
