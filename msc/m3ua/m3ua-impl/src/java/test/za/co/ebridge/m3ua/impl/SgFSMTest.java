...
import za.co.ebridge.m3ua.impl.message.*;
import za.co.ebridge.m3ua.impl.message.asptm.*;
import za.co.ebridge.m3ua.impl.message.transfer.*;
...
public class SgFSMTest
{
    ...
    @Test
    public void testSingleAspInAsWithRC()
            throws
            Exception
    {
        ...
        assertTrue(validateMessage(testAssociation, MessageClass.ASP_STATE_MAINTENANCE, MessageType.ASP_UP_ACK, -1,
                -1));
        ...
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AsInactive, System
                .currentTimeMillis(), new Object[]{remAs}, m3uaManagementEventsSeq++)));
        assertTrue(validateMessage(testAssociation, MessageClass.MANAGEMENT, MessageType.NOTIFY, Status
                        .STATUS_AS_State_Change,
        ...
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AspInactive, System
                .currentTimeMillis(), new Object[]{remAsp}, m3uaManagementEventsSeq++)));
        assertTrue(validateMessage(testAssociation, MessageClass.ASP_TRAFFIC_MAINTENANCE, MessageType
                .ASP_INACTIVE_ACK, -1, -1));
    ...
    @Test
    public void testSingleAspInAsWithoutRC()
            throws
            Exception
    {
        // 5.1.1. Single ASP in an Application Server ("1+0" sparing),
    ...
    @Test
    public void testSingleAspInMultipleAs()
            throws
            Exception
    {
    ...
    @Test
    public void testTwoAspInAsOverride()
            throws
            Exception
    {
        ...
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AspInactive, System
                .currentTimeMillis(), new Object[]{remAsp1}, m3uaManagementEventsSeq++)));
        assertTrue(validateMessage(testAssociation1, MessageClass.ASP_STATE_MAINTENANCE, MessageType.ASP_UP_ACK, -1,
                -1));
        ...
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AspInactive, System
                .currentTimeMillis(), new Object[]{remAsp2}, m3uaManagementEventsSeq++)));
        assertTrue(validateMessage(testAssociation2, MessageClass.ASP_STATE_MAINTENANCE, MessageType.ASP_UP_ACK, -1,
                -1));
        ...
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AspActive, System
                .currentTimeMillis(), new Object[]{remAsp1}, m3uaManagementEventsSeq++)));
        assertTrue(validateMessage(testAssociation1, MessageClass.ASP_TRAFFIC_MAINTENANCE, MessageType
                .ASP_ACTIVE_ACK, -1, -1));
        ...
        assertTrue(validateMessage(testAssociation2, MessageClass.ASP_TRAFFIC_MAINTENANCE, MessageType
                .ASP_ACTIVE_ACK, -1, -1));
        ...
        aspFactory1.read(message);
        assertEquals(AspState.DOWN, this.getAspState(asp1PeerFSM));
        assertTrue(validateMessage(testAssociation1, MessageClass.ASP_STATE_MAINTENANCE, MessageType.ASP_DOWN_ACK,
                -1, -1));
    ...
    @Test
    public void testTwoAsInLoadBalance()
            throws
            Exception
    {
        int m3uaManagementEventsSeq = 0;
        ...
        // Define 1st AS
        AsImpl remAs1 = (AsImpl) this.serverM3UAMgmt.createAs("testas1", Functionality.SGW, ExchangeType.SE, null,
                null, null,
                1, null);
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AsCreated, System
                .currentTimeMillis(), new Object[]{remAs1}, m3uaManagementEventsSeq++)));
        ...
        {
            Mtp3TransferPrimitive mtp3TransferPrimitive = factory.createMtp3TransferPrimitive(3, 1, 0, 1, 2, sls, new
                    byte[]{
                    1, 2, 3, 4});
    ...
    @Test
    public void testTwoAspInAsLoadshare()
            throws
            Exception
    {
        // 5.1.2. Two ASPs in Application Server ("1+1" Sparing)
        ...
        DestinationPointCode[] dpcObj = new DestinationPointCode[]{parmFactory.createDestinationPointCode(123,
                (short) 0)};
    ...
    @Test
    public void testAspUpReceivedWhileASPIsAlreadyUp()
            throws
            Exception
    {
        ...
        assertTrue(validateMessage(testAssociation1, MessageClass.MANAGEMENT, MessageType.ERROR, ErrorCode
                        .Unexpected_Message,
                100));
    ...
    private boolean validateMessage(TestAssociation testAssociation, int msgClass, int msgType, int type, int info)
    {
        ...
        if (message.getMessageClass() == MessageClass.MANAGEMENT)
        {
            ...
            {
                ErrorCode errCode = ((za.co.ebridge.m3ua.api.message.mgmt.Error) message).getErrorCode();
                if (errCode.getCode() != type)
                {
                    return false;
                }

                RoutingContext rc = ((za.co.ebridge.m3ua.api.message.mgmt.Error) message).getRoutingContext();
            ...
            implements Association
    {
        ...
        @Override
        public void acceptAnonymousAssociation(AssociationListener arg0)
                throws
                Exception
        {
            // TODO Auto-generated method stub
            ...
            implements Management
    {
        ...
        @Override
        public void startAssociation(String arg0)
                throws
                Exception
        {
            // TODO Auto-generated method stub
        ...
        @Override
        public void startServer(String arg0)
                throws
                Exception
        {
            // TODO Auto-generated method stub
        ...
        @Override
        public void stopAssociation(String arg0)
                throws
                Exception
        {
            // TODO Auto-generated method stub
        ...
        @Override
        public void stopServer(String arg0)
                throws
                Exception
        {
            // TODO Auto-generated method stub
        ...
        @Override
        public Association addAssociation(
                String arg0, int arg1, String arg2, int arg3, String arg4, IpChannelType arg5,
    ...
    class Mtp3UserPartListenerimpl
            implements Mtp3UserPartListener
    {
    ...
    private class M3UAManagementEventListenerImpl
            implements M3UAManagementEventListener
    {

        private FastSet<TestEvent> testEvents = new FastSet<TestEvent>();
        ...
        {
            TestEvent testEvent = new TestEvent(TestEventType.AspAssignedToAs, System.currentTimeMillis(), new
                    Object[]{as,
                    asp}, sequence++);
            this.testEvents.add(testEvent);
        }
        ...
        {
            TestEvent testEvent = new TestEvent(TestEventType.AspUnassignedFromAs, System.currentTimeMillis(), new
                    Object[]{
                    as, asp}, sequence++);
            this.testEvents.add(testEvent);
        }
        ...
        {
            TestEvent testEvent = new TestEvent(TestEventType.AspInactive, System.currentTimeMillis(), new
                    Object[]{asp},
                    sequence++);
            this.testEvents.add(testEvent);
        }
...
//            TestEvent testEventActual = this.testEvents.get(0);
//
