...
import za.co.ebridge.m3ua.impl.message.mgmt.*;
import za.co.ebridge.m3ua.impl.message.rkm.*;
...
public class MessageTest
{
            ...
            IOException
    {
        ...
        PayloadDataImpl msg = (PayloadDataImpl) messageFactory.createMessage(MessageClass.TRANSFER_MESSAGES,
                MessageType.PAYLOAD);
        ProtocolDataImpl p1 = (ProtocolDataImpl) parmFactory.createProtocolData(1408, 14150, 1, 1, 0, 0, new
                byte[]{1, 2, 3,
                4});
        msg.setData(p1);
        msg.encode(buffer);
    ...
    @Test
    public void testDestinationUnavailable()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);
    ...
    @Test
    public void testDestinationAvailable()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);
    ...
    @Test
    public void testSignallingCongestion()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);
    ...
    @Test
    public void testDestinationUPUnavailable()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);
    ...
    @Test
    public void testASPUp()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);

        ASPUpImpl msg = (ASPUpImpl) messageFactory.createMessage(MessageClass.ASP_STATE_MAINTENANCE, MessageType
                .ASP_UP);
    ...
    @Test
    public void testASPDown()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);

        ASPDownImpl msg = (ASPDownImpl) messageFactory.createMessage(MessageClass.ASP_STATE_MAINTENANCE, MessageType
                .ASP_DOWN);
    ...
    @Test
    public void testDeregistrationResponse()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);
    ...
    @Test
    public void testASPInactiveAck()
            throws
            IOException
    {
        ByteBuffer buffer = ByteBuffer.allocate(8192);
            ...
            IOException
    {
        ...
        byte[] data = new byte[]{0x01, 0x00, 0x03, 0x03, 0x00, 0x00, 0x00, 0x1c, 0x00, 0x09, 0x00, 0x14, 0x00, 0x02,
                0x00,
            ...
            IOException
    {
        ...
        byte[] data = new byte[]{0x01, 0x00, 0x03, 0x06, 0x00, 0x00, 0x00, 0x1c, 0x00, 0x09, 0x00, 0x14, 0x00, 0x02,
                0x00,
                0x00, 0x00, 0x07, (byte) 0xaf, 0x3e, 0x75, 0x40, 0x03, 0x13, 0x05, 0x07, 0x11, 0x20};

        byte[] heratbeatAckData = new byte[]{0x00, 0x02, 0x00, 0x00, 0x00, 0x07, (byte) 0xaf, 0x3e, 0x75, 0x40, 0x03,
                0x13,
                0x05, 0x07, 0x11, 0x20};
