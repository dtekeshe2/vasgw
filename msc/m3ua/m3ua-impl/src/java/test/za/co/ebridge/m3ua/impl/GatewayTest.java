...
public class GatewayTest
{
            ...
            Exception
    {
        ...
        this.m3uaMgmt.start();
        this.m3uaMgmt.removeAllResources();
    ...
    private class Mtp3UserPartListenerImpl
            implements Mtp3UserPartListener
    {

        private FastSet<Mtp3TransferPrimitive> receivedData = new FastSet<Mtp3TransferPrimitive>();

        public FastSet<Mtp3TransferPrimitive> getReceivedData()
        {
            return receivedData;
        }
