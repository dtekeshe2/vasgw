...
public class RemSgFSMTest
{
            ...
            Exception
    {
        ...
        AspFactoryImpl localAspFactory = (AspFactoryImpl) this.clientM3UAMgmt.createAspFactory("testasp",
                "testAssoc1", false);
        // Check if M3UAManagementEventListener received event
        ...
        M3UAMessageImpl message = messageFactory.createMessage(MessageClass.ASP_STATE_MAINTENANCE, MessageType
                .ASP_UP_ACK);
            ...
            Exception
    {
        ...
        AsImpl asImpl = (AsImpl) this.clientM3UAMgmt.createAs("testas", Functionality.AS, ExchangeType.SE, null,
                null, null, 1,
                null);
        // Check if M3UAManagementEventListener received event
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AsCreated, System
            ...
            Exception
    {
        ...
        // Define 1st AS
        AsImpl remAs1 = (AsImpl) this.clientM3UAMgmt.createAs("testas1", Functionality.AS, ExchangeType.SE, null,
                null, null,
                1, null);
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AsCreated, System
        ...
        // Define 2nd AS
        AsImpl remAs2 = (AsImpl) clientM3UAMgmt.createAs("testas2", Functionality.AS, ExchangeType.SE, null, null,
                null, 1,
                null);
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AsCreated, System
            ...
            Exception
    {
        ...
        assertTrue(this.m3uaManagementEventListenerImpl.validateEvent(new TestEvent(TestEventType.AspInactive, System
                .currentTimeMillis(), new Object[]{remAsp1}, m3uaManagementEventsSeq++)));
        assertTrue(validateMessage(testAssociation1, MessageClass.ASP_TRAFFIC_MAINTENANCE, MessageType.ASP_ACTIVE,
                -1, -1));
        ...
        assertEquals(AspState.ACTIVE_SENT, this.getAspState(asp2LocalFSM));
        assertTrue(validateMessage(testAssociation2, MessageClass.ASP_TRAFFIC_MAINTENANCE, MessageType.ASP_ACTIVE,
                -1, -1));
