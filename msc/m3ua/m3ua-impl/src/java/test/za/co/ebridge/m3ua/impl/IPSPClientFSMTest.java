...
public class IPSPClientFSMTest
{
     ...
     */
    @Test
    public void testSingleAspInAsWithRCSE()
            throws
            Exception
    {
        ...
        AsImpl asImpl = (AsImpl) this.clientM3UAMgmt.createAs("testas", Functionality.IPSP, ExchangeType.SE, null,
                rc, null, 1,
                null);
     ...
     */
    @Test
    public void testSingleAspInAsWithoutRCSE()
            throws
            Exception
    {
     ...
     */
    @Test
    public void testSingleAspInAsWithRCDE()
            throws
            Exception
    {
        ...
        // As as = rsgw.createAppServer("testas", rc, rKey, trModType);
        AsImpl asImpl = (AsImpl) this.clientM3UAMgmt.createAs("testas", Functionality.IPSP, ExchangeType.DE, null,
                rc, null, 1,
                null);
    ...
    /**
     * Validate that next message in Association queue if of Class and Type passed as argument. type and info are
     * only for
     * management messages
     *
