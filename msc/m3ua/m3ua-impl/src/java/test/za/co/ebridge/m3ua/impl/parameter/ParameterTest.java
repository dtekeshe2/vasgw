...
public class ParameterTest
{
            ...
            IOException
    {
        ...
        byte[] userData = new byte[]{0x09, (byte) 0x80, 0x03, 0x0c, 0x15, 0x09, 0x12, 0x05, 0x00, 0x12, 0x04, 0x55,
                0x16,
                0x09, (byte) 0x90, 0x09, 0x12, 0x07, 0x00, 0x12, 0x04, 0x55, 0x16, 0x09, 0x00, 0x5f, 0x62, 0x5d,
                0x48, 0x04,
                0x3a, (byte) 0x8c, 0x10, 0x04, 0x6b, 0x3f, 0x28, 0x3d, 0x06, 0x07, 0x00, 0x11, (byte) 0x86, 0x05,
                0x01, 0x01,
                0x01, (byte) 0xa0, 0x32, 0x60, 0x30, (byte) 0x80, 0x02, 0x07, (byte) 0x80, (byte) 0xa1, 0x09, 0x06,
                0x07, 0x04,
                0x00, 0x00, 0x01, 0x00, 0x13, 0x02, (byte) 0xbe, 0x1f, 0x28, 0x1d, 0x06, 0x07, 0x04, 0x00, 0x00,
                0x01, 0x01,
                0x01, 0x01, (byte) 0xa0, 0x12, (byte) 0xa0, 0x10, (byte) 0x80, 0x07, (byte) 0x91, 0x55, 0x16, 0x28,
                (byte) 0x81, 0x00, 0x70, (byte) 0x81, 0x05, (byte) 0x91, 0x55, 0x16, 0x09, 0x00, 0x6c, 0x14, (byte)
                0xa1, 0x12,
                0x02, 0x01, 0x00, 0x02, 0x01, 0x3b, 0x30, 0x0a, 0x04, 0x01, 0x0f, 0x04, 0x05, 0x2a, (byte) 0xd9,
                (byte) 0x8c,
                0x36, 0x02};
    ...
    @Test
    public void testNetworkAppearance()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testRoutingContext()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testRoutingContexts()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testAffectedPointCode()
            throws
            IOException
    {
        ...
        AffectedPointCodeImpl affectedPc2 = (AffectedPointCodeImpl) factory.createParameter(getTag(data), getValue
                (data));
    ...
    @Test
    public void testAffectedPointCodes()
            throws
            IOException
    {
    ...
    @Test
    public void testCongestedIndication()
            throws
            IOException
    {
    ...
    @Test
    public void testDestinationPointCode()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testLocalRKIdentifier()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testServiceIndicators()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testTrafficModeType()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testRoutingKeySerialization1()
            throws
            IOException,
            XMLStreamException
    {
    ...
    @Test
    public void testDeregistrationStatus()
            throws
            IOException
    {
        ...
        DeregistrationStatusImpl crrId2 = (DeregistrationStatusImpl) factory.createParameter(getTag(data), getValue
                (data));
    ...
    @Test
    public void testDeregistrationResult()
            throws
            IOException
    {
        RoutingContext rc = factory.createRoutingContext(new long[]{1});
