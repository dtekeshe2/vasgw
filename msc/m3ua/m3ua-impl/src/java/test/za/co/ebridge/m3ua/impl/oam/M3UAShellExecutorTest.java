...
import za.co.ebridge.m3ua.impl.Util;
...
public class M3UAShellExecutorTest
{
            ...
            Exception
    {
        ...
        assertEquals(result, "java.lang.Exception: " + String.format(M3UAOAMMessages.CREATE_AS_FAIL_NAME_EXIST,
                "testas"));
        ...
        result = m3uaExec
                .execute(("m3ua as create testas2 AS mode DE ipspType CLIENT rc 100 traffic-mode loadshare " +
        ...
        // Error for same name
        result = m3uaExec.execute("m3ua asp create testasp1 testAssoc1".split(" "));
        assertEquals(result, "java.lang.Exception: " + String.format(M3UAOAMMessages.CREATE_ASP_FAIL_NAME_EXIST,
                "testasp1"));

        // Error : Try to start Asp without assiging to any As
        result = m3uaExec.execute("m3ua asp start testasp1".split(" "));
        assertEquals(result, "java.lang.Exception: " + String.format(M3UAOAMMessages.ASP_NOT_ASSIGNED_TO_AS,
                "testasp1"));
        ...
        // add again
        result = m3uaExec.execute("m3ua as add testas testasp1".split(" "));
        assertEquals(result, "java.lang.Exception: " + String.format(M3UAOAMMessages
                .ADD_ASP_TO_AS_FAIL_ALREADY_ASSIGNED_TO_THIS_AS, "testasp1", "testas"));
        ...
        assertEquals(result, "java.lang.Exception: " + String.format(M3UAOAMMessages.AS_USED_IN_ROUTE_ERROR,
                "testas", "2:-1:-1"));
