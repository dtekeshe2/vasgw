...
public class AspImpl
        implements XMLSerializable, Asp
{
    ...
    private void initLocalFSM()
    {
        ...
        this.localFSM.createTimeoutTransition(
                AspState.UP_SENT.toString(), AspState.UP_SENT.toString(), 2000).setHandler(
                new THLocalAspDwnToAspUpSnt(this, this.localFSM));

        this.localFSM.createTransition(
                TransitionState.ASP_INACTIVE, AspState.UP_SENT.toString(), AspState.INACTIVE.toString());
        ...
        this.localFSM.createTransition(
                TransitionState.COMM_DOWN, AspState.UP_SENT.toString(), AspState.DOWN.toString());
        ...
        this.localFSM.createTransition(
                TransitionState.COMM_DOWN, AspState.ACTIVE_SENT.toString(), AspState.DOWN.toString());
        ...
        this.localFSM
                .createTransition(
                        TransitionState.ASP_DOWN_SENT, AspState.ACTIVE.toString(), AspState.DOWN_SENT.toString());

        this.localFSM.createTransition(
                TransitionState.COMM_DOWN, AspState.ACTIVE.toString(), AspState.DOWN.toString());
        ...
        // ******************************************************************/
        this.localFSM.createTransition(
                TransitionState.COMM_DOWN, AspState.INACTIVE.toString(), AspState.DOWN.toString());
        ...
        this.localFSM.createTimeoutTransition(
                AspState.INACTIVE_SENT.toString(), AspState.INACTIVE_SENT.toString(), 2000);
        ...
        this.localFSM.createTransition(
                TransitionState.COMM_DOWN, AspState.INACTIVE_SENT.toString(), AspState.DOWN.toString());

        // ******************************************************************/
        // DOWN_SENT/
        // ******************************************************************/
        this.localFSM.createTransition(
                TransitionState.ASP_DOWN_ACK, AspState.DOWN_SENT.toString(), AspState.DOWN.toString());

        this.localFSM.createTransition(
                TransitionState.COMM_DOWN, AspState.DOWN_SENT.toString(), AspState.DOWN.toString());
    }
    ...
    private void initPeerFSM()
    {
        ...
        this.peerFSM.createTransition(
                TransitionState.ASP_ACTIVE, AspState.INACTIVE.toString(), AspState.ACTIVE.toString());

        // TODO: Ignore payload if Remote ASP is still INACTIVE. may be log
        // it?
        this.peerFSM.createTransition(
                TransitionState.PAYLOAD, AspState.INACTIVE.toString(), AspState.INACTIVE.toString());
        ...
        this.peerFSM.createTransition(
                TransitionState.ASP_INACTIVE, AspState.ACTIVE.toString(), AspState.INACTIVE.toString());
     ...
     */
    protected static final XMLFormat<AspImpl> ASP_XML = new XMLFormat<AspImpl>()
    {

        @Override
        public void read(javolution.xml.XMLFormat.InputElement xml, AspImpl aspImpl)
                throws
                XMLStreamException
        {
        ...
        @Override
        public void write(AspImpl aspImpl, javolution.xml.XMLFormat.OutputElement xml)
                throws
                XMLStreamException
        {
