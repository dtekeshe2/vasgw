...
public class OPCListImpl
        ...
        implements OPCList, XMLSerializable
{
    ...
    {
        return String.format("OPCList pointCode=%s mask=%s",
                                Arrays.toString(this.pointCodes), Arrays.toString(this.masks));
    }

    /**
     * XML Serialization/De-serialization
     */
    protected static final XMLFormat<OPCListImpl> RC_XML = new XMLFormat<OPCListImpl>()
    {

        @Override
        public void read(javolution.xml.XMLFormat.InputElement xml, OPCListImpl opc)
        ...
        @Override
        public void write(OPCListImpl opc, javolution.xml.XMLFormat.OutputElement xml)
                throws XMLStreamException
        {
