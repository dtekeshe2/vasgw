...
import za.co.ebridge.m3ua.impl.AspFactoryImpl;
        ...
        implements ShellExecutor
{
    ...
    /**
     * m3ua as create <as-name> <AS | SGW | IPSP> mode <SE | DE> ipspType < client | server > rc <routing-context>
     * traffic-mode
     ...
     * @return
     */
    private String createAs(String[] args)
            throws
            Exception
    {
     ...
     * @throws Exception
     */
    private String destroyAs(String[] args)
            throws
            Exception
    {
        if (args.length < 4)
     ...
     * @throws Exception
     */
    private String addAspToAs(String[] args)
            throws
            Exception
    {
        if (args.length < 5)
     ...
     * @throws Exception
     */
    private String removeAspFromAs(String[] args)
            throws
            Exception
    {
        if (args.length < 5)
