...
public class RoutingContextImpl
        ...
        implements RoutingContext, XMLSerializable
{
     ...
     */
    protected static final XMLFormat<RoutingContextImpl> RC_XML = new XMLFormat<RoutingContextImpl>()
    {

        @Override
        public void read(javolution.xml.XMLFormat.InputElement xml, RoutingContextImpl rc)
        ...
        @Override
        public void write(RoutingContextImpl rc, javolution.xml.XMLFormat.OutputElement xml)
                throws XMLStreamException
        {
