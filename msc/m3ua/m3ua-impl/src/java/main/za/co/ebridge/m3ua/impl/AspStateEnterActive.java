...
public class AspStateEnterActive
        implements FSMStateEventHandler
{
    ...
    public void onEvent(FSMState state)
    {
        ...
        if (!this.aspImpl.state.getName().equals(State.STATE_ACTIVE))
        {
            ...
            List<M3UAManagementEventListener> managementEventListenersTmp = this.aspImpl.aspFactoryImpl.m3UAManagementImpl.managementEventListeners;
