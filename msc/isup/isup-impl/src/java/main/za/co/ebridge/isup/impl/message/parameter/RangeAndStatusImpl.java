...
public class RangeAndStatusImpl extends AbstractISUPParameter implements RangeAndStatus {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.RangeAndStatus#isAffected (byte)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.RangeAndStatus#setAffected (byte, boolean)
     */
