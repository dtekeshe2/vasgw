...
import za.co.ebridge.isup.api.ISUPEvent;
import za.co.ebridge.isup.api.ISUPTimeoutEvent;
import za.co.ebridge.isup.api.ParameterException;
import za.co.ebridge.isup.impl.message.AbstractISUPMessage;
...
import za.co.ebridge.scheduler.ConcurrentLinkedList;
...
class Circuit
{
     ...
     * @throws IOException
     */
    private Mtp3TransferPrimitive decorate(ISUPMessage message)
            throws
            ParameterException,
            IOException
    {
