...
import za.co.ebridge.isup.api.CircuitManager;
...
public class CircuitManagerImpl implements CircuitManager
{
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.CircuitManager#addCircuit(int, int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.CircuitManager#removeCircuit(int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.CircuitManager#isCircuitPresent(int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.CircuitManager#getChannelIDs()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.CircuitManager#getCIC()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.CircuitManager#getDPC()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.CircuitManager#getChannelID(int,int)
     */
    @Override
