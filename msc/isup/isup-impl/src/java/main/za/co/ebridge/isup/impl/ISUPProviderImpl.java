package za.co.ebridge.isup.impl;
...
import za.co.ebridge.isup.api.*;
import za.co.ebridge.isup.api.message.ISUPMessage;
import za.co.ebridge.isup.impl.message.ISUPMessageFactoryImpl;
import za.co.ebridge.isup.impl.message.parameter.ISUPParameterFactoryImpl;
        ...
        implements ISUPProvider
{
    ...
    public ISUPProviderImpl(
            ISUPStackImpl isupStackImpl, Scheduler scheduler, int ni, int localSpc,
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.ISUPProvider#getMessageFactory()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.ISUPProvider#getParameterFactory()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.ISUPProvider#sendMessage(org.mobicents .protocols
     * .protocols.ss7.cap.api.isup.message.ISUPMessage)
     */

    public void sendMessage(ISUPMessage msg, int dpc)
            throws
            ParameterException,
            IOException
    {
    ...
    void sendOnCircuit(Circuit c, ISUPMessage msg)
            throws
            ParameterException,
            IOException
    {
    ...
    private Circuit getCircuit(ISUPMessage message, int dpc)
    {
        ...
        if (!this.stack.getCircuitManager().isCircuitPresent(cic, dpc))
        {
            ...
            // what for do we need to throw this error , lets simply add a circuit and return it , we have all
            // parameters anyway
    ...
    void send(Mtp3TransferPrimitive encoded)
            throws
            IOException
    {
