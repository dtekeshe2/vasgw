...
import za.co.ebridge.isup.impl.message.parameter.CircuitStateIndicatorImpl;
...
public class CircuitGroupQueryResponseMessageImpl extends ISUPMessageImpl implements CircuitGroupQueryResponseMessage {
    ...
    CircuitGroupQueryResponseMessageImpl(Set<Integer> mandatoryCodes, Set<Integer> mandatoryVariableCodes,
