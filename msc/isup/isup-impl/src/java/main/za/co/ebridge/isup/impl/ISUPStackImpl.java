...
public class ISUPStackImpl
        implements ISUPStack, Mtp3UserPartListener
{
    ...
    public ISUPStackImpl(
            ...
            final int localSpc,
            final int ni,
            final boolean automaticTimerMessages)
    {
        super();
     ...
     * @param message
     */
    void send(Mtp3TransferPrimitive message)
            throws
            IOException
    {
    ...
    // // http://pt.com/page/tutorials/protocols.ss7.cap.api-tutorial/mtp
