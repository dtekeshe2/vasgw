...
import za.co.ebridge.isup.api.message.parameter.UserServiceInformationBase;
...
public abstract class UserServiceInformationBaseImpl extends AbstractISUPParameter implements UserServiceInformationBase {
    ...
    public int decode(byte[] b) throws ParameterException {
        ...
        // TODO: ext bits exists here but decoder does not care about them
        ...
        while (index < b.length) {
            ...
            switch (tempValue) {
                case _LAYER1_IDENTIFIER:
                    ...
                    // note 2 This octet may be present if octet 3 indicates unrestricted digital information and octet 5
                    // indicates either
                    // of the ITU-T standardized rate adaptions V.110, I.460 and X.30 or V.120 [9]. It may also be present if
                    // octet 3
                        ...
                        switch (this.l1UserInformation) {
                            ...
                            case _L1_NON_ITUT:
                                ...
                                if (this.syncMode == _SA_SYNC) {
                                    // NOTE 3 This structure of octet 5b only applies if octet 5 indicates ITU-T standardized
                                    // rate adaption (see
                            ...
                            case _L1_ITUT_120:
                                ...
                                if (this.syncMode == _SA_SYNC) {
                                    // NOTE 4 This structure of octet 5b only applies if octet 5 indicates ITU-T standardized
                                    // rate adaption (see
