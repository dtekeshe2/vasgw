...
public class CircuitIdentificationCodeImpl extends AbstractISUPParameter implements CircuitIdentificationCode {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.CircuitIdentificationCode#getCIC()
     */
    public int getCIC() {
        return this.cic;
    }
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.CircuitIdentificationCode#setCIC(long)
     */
