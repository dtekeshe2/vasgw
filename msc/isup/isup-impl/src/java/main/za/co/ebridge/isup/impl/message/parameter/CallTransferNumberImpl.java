...
public class CallTransferNumberImpl extends AbstractNAINumber implements CallTransferNumber {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.AbstractNumber#decodeBody(java.io.ByteArrayInputStream)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.AbstractNumber#encodeBody(java.io.ByteArrayOutputStream)
     */
    /*
     * (non-Javadoc)
     *
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.ISUPParameter#getCode()
     */
    public int getCode() {
