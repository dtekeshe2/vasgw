...
class AnswerMessageImpl extends ISUPMessageImpl implements AnswerMessage {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.AnswerMessage#getDisplayInformation ()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.AnswerMessage#getRedirectionNumber ()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.AnswerMessage#setDisplayInformation
     * (org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.DisplayInformation)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.isup.message.AnswerMessage#setRedirectionNumber
     * (org.mobicents.protocols.protocols.ss7.cap.api.isup.message.parameter.RedirectionNumber)
     */
