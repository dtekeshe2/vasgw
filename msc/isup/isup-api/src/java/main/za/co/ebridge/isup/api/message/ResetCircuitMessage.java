 ...
 * Reset Circuit (RSC) message sent to release a circuit/CIC when, due to memory mutilation or other causes, it is
 * unknown
 * whether for example, a Release or a Release Complete message is appropriate. If, at the receiving end, the
 * circuit/CIC is
 * remotely blocked, reception of this message should cause that condition to be removed.</TD>
 * </TR>
 * </TABLE>
 * </TD>
 * <p/>
