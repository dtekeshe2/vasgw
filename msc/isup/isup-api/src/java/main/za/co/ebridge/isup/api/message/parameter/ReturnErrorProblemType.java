...
public enum ReturnErrorProblemType
{
    ...
    /**
     * The error code is not one of those agreed by the two TC-User. This code is generated by the TC-User (not by
     * TCAP layer).
     */
    UnrecognizedError(2),

    /**
     * The received error is not one of those that the invoked operation may report. This code is generated by the
     * TC-User (not
     * by TCAP layer).
     */
    UnexpectedError(3),
    ...
    /**
     * Signifies that the type parameter in a Return Error component is not that agreed by the two TC-Users. This
     * code is
    ...
    public static ReturnErrorProblemType getFromInt(long t)
            throws
            ParameterException
    {
        if (t == 0)
