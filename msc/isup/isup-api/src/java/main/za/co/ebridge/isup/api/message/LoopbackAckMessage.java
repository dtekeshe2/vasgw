 ...
 * Loop Back Acknowledgement (LPA)</TD>
 * <p/>
 * </TR>
 * <p/>
 * <TR>
 * <TD style="FONT-SIZE: 9pt; BORDER-BOTTOM: silver thin solid" colSpan="3">Loop Back Acknowledgement (LPA) message
 * sent in the
 * backward direction in response to a continuity check request message indicating that a loop (or transceiver in the
 * case of a
 * 2-wire circuit) has been connected.</TD>
 * </TR>
 * <p/>
 * </TABLE>
 * </TD>
 ...
 * </TABLE>
 */
public interface LoopbackAckMessage
        extends ISUPMessage
{
    /**
