 ...
 * <TABLE id="Table27" style="FONT-SIZE: 9pt; WIDTH: 584px; HEIGHT: 72px; TEXT-ALIGN: center" cellSpacing="1"
 ...
 * colSpan="3">
 * <p/>
 * <TABLE id="Table56" style="WIDTH: 575px; COLOR: navy; HEIGHT: 49px" cellSpacing="1" cellPadding="1" width="575"
 * border="0">
 * <TR>
 ...
 * <FONT face="Times New Roman" size="3">User Part Available (UPA)&nbsp;message sent in either direction as a
 * response to a user
 ...
 * </TABLE>
 */
public interface UserPartAvailableMessage
        extends ISUPMessage
{
    /**
