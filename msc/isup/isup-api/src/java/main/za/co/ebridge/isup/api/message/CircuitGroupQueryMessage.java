 ...
 * <FONT face="Times New Roman" size="3"> <SPAN lang="EN-GB" style=
 * "FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; mso-bidi-font-size: 10.0pt; mso-fareast-font-family: 'Times New
 * Roman'; mso-ansi-language: EN-GB; mso-fareast-language: EN-US; mso-bidi-language: AR-SA"
 * >Circuit Group Query (CQM)&nbsp;message sent on a routine or demand basis to request the far-end node to give the
 * state of
 * all circuits/CICs in a particular range. </SPAN> </FONT></TD>
 * <p/>
 * </TR>
 * </TABLE>
 * </TD>
