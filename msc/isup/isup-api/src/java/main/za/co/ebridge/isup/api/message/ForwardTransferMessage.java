 ...
 * <TABLE id="Table20" style="FONT-SIZE: 9pt; WIDTH: 584px; HEIGHT: 72px; TEXT-ALIGN: center" cellSpacing="1"
 ...
 * <FONT face="Times New Roman" size="3">A message sent in the forward direction on semi automatic calls when the
 * outgoing
 * international exchange operator wants the help of an operator at the incoming international exchange. The message
 * will
 * normally serve to bring an assistance operator into the call if the call is automatically set up at the exchange
 * .</FONT></TD>
 * </TR>
 * </TABLE>
 * </TD>
 ...
 * </TABLE>
 */
public interface ForwardTransferMessage
        extends ISUPMessage
{
    /**
