 ...
 * <TABLE id="Table30" style="FONT-SIZE: 9pt; WIDTH: 584px; HEIGHT: 72px; TEXT-ALIGN: center" cellSpacing="1"
 ...
 * <FONT face="Times New Roman" size="3">Identification Request (IDR)&nbsp;message sent in the backward direction to
 * request
 ...
 * </TABLE>
 */
public interface IdentificationRequestMessage
        extends ISUPMessage
{
    /**
