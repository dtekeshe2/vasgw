...
/**
 * <TABLE id="Table15" style="FONT-SIZE: 9pt; WIDTH: 584px; HEIGHT: 72px; TEXT-ALIGN: center" cellSpacing="1"
 ...
 * <p/>
 * An Initial Address Message (IAM) is sent in the "forward" direction by each switch needed to complete the circuit
 * between the
 * calling party and called party until the circuit connects to the destination switch. An IAM contains the called
 * party number
