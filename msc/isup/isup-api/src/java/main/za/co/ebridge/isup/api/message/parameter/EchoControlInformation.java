...
public interface EchoControlInformation
        extends ISUPParameter
{
    ...
    /**
     * See Q.763 3.19 Outgoing echo control device information indicator : outgoing echo control device not included
     * and not
     * available
     */
    ...
    /**
     * See Q.763 3.19 Incoming echo control device information indicator : incoming echo control device not included
     * and not
     * available
     */
    ...
    /**
     * See Q.763 3.19 Incoming echo control device request indicator : incoming echo control device deactivation
     * request (Note
     * 2)
     */
    ...
    /**
     * See Q.763 3.19 Outgoing echo control device request indicator : outgoing echo control device deactivation
     * request (Note
     * 1)
     */
    ...
    void setOutgoingEchoControlDeviceInformationRequestIndicator(int
            outgoingEchoControlDeviceInformationRequestIndicator);
