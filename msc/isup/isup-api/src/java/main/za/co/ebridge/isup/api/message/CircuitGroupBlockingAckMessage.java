 ...
 * <FONT face="Times New Roman" size="3"> <FONT face="Times New Roman" size="3">Circuit Group Blocking
 * Acknowledgement&nbsp;(CGBA) </FONT> message sent in response to a Circuit/CIC Group Blocking message to indicate
 * that the
 ...
 * </TABLE>
 */
public interface CircuitGroupBlockingAckMessage
        extends ISUPMessage
{
    /**
