...
public interface RedirectionInformation
        extends ISUPParameter
{
    ...
    /**
     * See Q.763 3.45 Redirecting indicator call rerouted, all redirection information presentation restricted
     * (national use)
     */
    ...
    void setRedirectionCounter(int redirectionCounter)
            throws
