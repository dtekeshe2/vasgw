...
/**
 * <TABLE id="Table26" style="FONT-SIZE: 9pt; WIDTH: 584px; HEIGHT: 72px; TEXT-ALIGN: center" cellSpacing="1"
 ...
 * information between two signalingpoints along the same signalingpath as that used to establish a physical
 * connection between
 ...
 * </TABLE>
 */
public interface PassAlongMessage
        extends ISUPMessage
{
    /**
