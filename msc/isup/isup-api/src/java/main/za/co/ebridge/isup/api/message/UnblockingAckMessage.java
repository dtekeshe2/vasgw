 ...
 * Unblocking Acknowledgement (UBA)</TD>
 * <p/>
 * </TR>
 * <p/>
 * <TR>
 * <TD style="FONT-SIZE: 9pt; BORDER-BOTTOM: silver thin solid" colSpan="3">
 * Unblocking Acknowledgement (UBA) message sent in response to an unblocking message indicating that the circuit has
 * been
 * unblocked.</TD>
 * </TR>
 * <p/>
 ...
 * </TABLE>
 */
public interface UnblockingAckMessage
        extends ISUPMessage
{
    /**
