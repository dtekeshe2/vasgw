 ...
 * <p/>
 * This scheduler implementation follows to uniprocessor model with "super" thread. The "super" thread includes IO
 * bound thread
 * and one or more CPU bound threads with equal priorities.
 * <p/>
 * The actual priority is assigned to task instead of process and can be changed dynamically at runtime using the
 * initial
...
public class Scheduler
{
            ...
            extends Thread
    {
        ...
        public CpuThread(String name)
        {
            ...
            eservice = new ThreadPoolExecutor(size, size, 0L, TimeUnit.MILLISECONDS, new
                    ConcurrentLinkedList<Runnable>());
        }
