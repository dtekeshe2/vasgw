...
public interface SccpResource
{
    ...
    void modifyRemoteSsn(
            int remoteSsnid, int remoteSpc, int remoteSsn, int remoteSsnFlag,
            boolean markProhibitedWhenSpcResuming)
            throws
            Exception;

    void removeRemoteSsn(int remoteSsnid)
            throws
            Exception;
    ...
    void addRemoteSpc(int remoteSpcId, int remoteSpc, int remoteSpcFlag, int mask)
            throws
            Exception;

    void modifyRemoteSpc(int remoteSpcId, int remoteSpc, int remoteSpcFlag, int mask)
            throws
            Exception;

    void removeRemoteSpc(int remoteSpcId)
            throws
            Exception;
    ...
    void addConcernedSpc(int concernedSpcId, int remoteSpc)
            throws
            Exception;

    void removeConcernedSpc(int concernedSpcId)
            throws
            Exception;

    void modifyConcernedSpc(int concernedSpcId, int remoteSpc)
            throws
            Exception;
