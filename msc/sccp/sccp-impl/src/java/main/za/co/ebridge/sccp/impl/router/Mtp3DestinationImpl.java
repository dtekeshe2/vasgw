...
public class Mtp3DestinationImpl
        implements XMLSerializable, Mtp3Destination
{
    ...
    public String toString()
    {
        ...
        sb.append("firstDpc=").append(this.firstDpc).append(", lastDpc=").append(this.lastDpc).append(", firstSls=")
                .append(this.firstSls).append(", lastSls=").append(this.lastSls).append(", slsMask=").append(this
                .slsMask);
        return sb.toString();
    }

    protected static final XMLFormat<Mtp3DestinationImpl> XML = new XMLFormat<Mtp3DestinationImpl>()
    {

        public void write(Mtp3DestinationImpl dest, OutputElement xml)
                throws
                XMLStreamException
        {
        ...
        public void read(InputElement xml, Mtp3DestinationImpl dest)
                throws
                XMLStreamException
        {
