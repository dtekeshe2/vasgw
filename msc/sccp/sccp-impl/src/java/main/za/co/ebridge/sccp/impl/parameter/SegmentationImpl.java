        ...
        implements Segmentation
{
    ...
    public SegmentationImpl(
            boolean firstSegIndication,
            boolean class1Selected,
            byte remainingSegments,
            int segmentationLocalRef)
    {
        super();
    ...
    /**
     * Bit 7 of octet 1 is used to keep in the message in sequence delivery option required by the SCCP user and is
     * coded as
     * follows:
     *
    ...
    /**
     * Bits 4-1 of octet 1 are used to indicate the number of remaining segments. The values 0000 to 1111 are
     * possible; the
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.sccp.OptionalParameter#decode(byte[])
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.sccp.OptionalParameter#encode()
     */
