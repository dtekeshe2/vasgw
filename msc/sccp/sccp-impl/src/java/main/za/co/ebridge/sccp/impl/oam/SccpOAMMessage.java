...
public interface SccpOAMMessage
{
    ...
    String RULETYPE_NOT_SOLI_SEC_ADD_MANDATORY = "If RuleType is not Solitary, specifying Secondar Address is " +
            "mandatory";

    String SEC_MISMATCH_PATTERN = "Number of sections in mask doesn't match with number of sections in pattern " +
            "GlobalTitle digits";

    String SEC_MISMATCH_PRIMADDRESS = "Number of sections in mask doesn't match with number of sections in primary " +
            "address GlobalTitle digits";

    String SEC_MISMATCH_SECADDRESS = "Number of sections in mask doesn't match with number of sections in secondary " +
            "address GlobalTitle digits";
