package za.co.ebridge.sccp.impl.oam;
...
import za.co.ebridge.management.console.ShellExecutor;
        ...
        implements ShellExecutor
{
            ...
            Exception
    {
        ...
        if (command.equals("create"))
        {
            ...
            this.sccpResource.addRemoteSsn(remoteSsId, remoteSpc, remoteSs, remoteSsFlag,
     ...
     * <p/>
     * sccp rule create <id> <mask> <address-indicator> <point-code> <subsystem-number> <translation-type>
     *     <numbering-plan>
            ...
            Exception
    {
        ...
        this.router
                .addRule(ruleId, ruleType, algo, originationType, pattern, mask, pAddressId, sAddressId,
                        newcgpartyAddressId);
    ...
    private SccpAddress createAddress(String[] options, int index)
            throws
            Exception
    {
        ...
        {
            throw new Exception(String.format("Address Indicator %d indicates that SSN is present, however SSN passed" +
                    " is 0", ai));
        }

        if (aiObj.pcPresent() && pc == 0)
        {
            throw new Exception(String.format("Address Indicator %d indicates that PointCode is present, however " +
                    "PointCode passed is 0", ai));
        }
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.ss7.cap.api.management.console.ShellExecutor#handles(java.lang. String)
     */
    @Override
