...
public class RemoteSubSystemImpl
        implements XMLSerializable, RemoteSubSystem
{
...
//            return false;
    ...
    protected static final XMLFormat<RemoteSubSystemImpl> XML = new XMLFormat<RemoteSubSystemImpl>()
    {
        ...
        public void write(RemoteSubSystemImpl ai, OutputElement xml)
                throws
                XMLStreamException
        {
        ...
        public void read(InputElement xml, RemoteSubSystemImpl ai)
                throws
                XMLStreamException
        {
