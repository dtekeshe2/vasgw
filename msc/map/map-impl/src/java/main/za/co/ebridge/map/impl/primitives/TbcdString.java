        ...
        implements MAPAsnPrimitive
{
    ...
    public static String decodeString(InputStream ansIS, int length)
            throws
            IOException,
            MAPParsingComponentException
    {
    ...
    public static void encodeString(OutputStream asnOs, String data)
            throws
            MAPException
    {
    ...
    protected static int encodeNumber(char c)
            throws
            MAPException
    {
        switch (c)
        {
            ...
            default:
                throw new MAPException(
                        "char should be between 0 - 9, *, #, a, b, c for Telephony Binary Coded Decimal String. " +
                                "Received " + c);

        }
    }

    protected static char decodeNumber(int i)
            throws
            MAPParsingComponentException
    {
        switch (i)
