...
public class SGSNCapabilityImpl
        extends SequenceBase
        implements SGSNCapability
{
                ...
                case Tag.CLASS_CONTEXT_SPECIFIC:
                {
                    switch (tag)
                    {
                        case TAG_extensionContainer:
                            ...
                            break;
                        case TAG_superChargerSupportedInServingNetworkEntity: //
            ...
            MAPException
    {
        ...
        try
        {
            ...
            if (this.supportedLCSCapabilitySets != null)
                ((SupportedLCSCapabilitySetsImpl) this.supportedLCSCapabilitySets).encodeAll(asnOs, Tag
