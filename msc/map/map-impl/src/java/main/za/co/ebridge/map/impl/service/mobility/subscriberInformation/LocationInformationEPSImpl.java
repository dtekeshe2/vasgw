...
public class LocationInformationEPSImpl
        ...
        implements LocationInformationEPS
{
                    ...
                    case _ID_currentLocationRetrieved:
                        if (!ais.isTagPrimitive())
                        {
                            throw new MAPParsingComponentException(
                                    "Error while decoding LocationInformation: Parameter [currentLocationRetrieved   " +
                                            " [8] NULL ] not primitive",
                                    MAPParsingComponentExceptionReason.MistypedParameter);
                        }
                        ais.readNull();
            ...
            MAPException
    {
        try
        {
            ...
            {
                ((TAIdImpl) this.trackingAreaIdentity).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.geographicalInformation != null)
                ((GeographicalInformationImpl) this.geographicalInformation).encodeAll(asnOs, Tag
            ...
            if (this.currentLocationRetrieved)
            {
                ...
                catch (IOException e)
                {
                    throw new MAPException(
                            "Error while encoding LocationInformation the optional parameter currentLocationRetrieved" +
                                    " encoding failed ",
                            e);
                }
            ...
            if (ageOfLocationInformation != null)
                asnOs.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_ageOfLocationInformation, (int)
     ...
     */
    protected static final XMLFormat<LocationInformationEPSImpl> LOCATION_INFORMATION_EPS_XML = new
            XMLFormat<LocationInformationEPSImpl>()
    {
        ...
        public void read(javolution.xml.XMLFormat.InputElement xml, LocationInformationEPSImpl locationInformationEPS)
                ...
                XMLStreamException
        {
            locationInformationEPS.eUtranCellGlobalIdentity = xml.get(E_UTRAN_CELL_GLOBAL_IDENTITY, EUtranCgiImpl
                    .class);
                ...
                XMLStreamException
        {
            ...
            {
                xml.add((GeographicalInformationImpl) locationInformationEPS.geographicalInformation,
