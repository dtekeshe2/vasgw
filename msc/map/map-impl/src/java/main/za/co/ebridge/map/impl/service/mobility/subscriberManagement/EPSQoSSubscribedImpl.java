        ...
        implements EPSQoSSubscribed
{
    ...
    public EPSQoSSubscribedImpl(
            QoSClassIdentifier qoSClassIdentifier, AllocationRetentionPriority allocationRetentionPriority,
            ...
            MAPException
    {
        ...
        try
        {
            ...
            if (this.qoSClassIdentifier != null)
                asnOs.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_qoSClassIdentifier, this.qoSClassIdentifier
                        .getCode());

            ((AllocationRetentionPriorityImpl) this.allocationRetentionPriority).encodeAll(asnOs, Tag
