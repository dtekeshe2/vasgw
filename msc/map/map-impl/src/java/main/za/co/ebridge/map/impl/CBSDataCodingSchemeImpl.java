...
import za.co.ebridge.map.api.datacoding.CBSDataCodingGroup;
import za.co.ebridge.map.api.datacoding.CBSDataCodingScheme;
import za.co.ebridge.map.api.datacoding.CBSNationalLanguage;
        ...
        implements CBSDataCodingScheme
{
    ...
    public CBSDataCodingSchemeImpl( CBSDataCodingGroup dataCodingGroup,
                                    CharacterSet characterSet,
                                    CBSNationalLanguage nationalLanguageShiftTable,
                                    DataCodingSchemaMessageClass messageClass,
