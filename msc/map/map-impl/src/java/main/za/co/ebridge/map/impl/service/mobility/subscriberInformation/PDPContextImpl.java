        ...
        implements PDPContext
{
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.subscriberInformation.PDPContext
     * #getPDPContextId()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.subscriberInformation.PDPContext #getPDPType()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.subscriberInformation.PDPContext #getAPN()
     */
    public APN getAPN()
    {
        return this.apn;
            ...
            AsnException
    {
                ...
                case Tag.CLASS_CONTEXT_SPECIFIC:
                {
                    switch (tag)
                    {
                        ...
                        case _ID_sipto_Permission:
                            if (!ais.isTagPrimitive())
                                throw new MAPParsingComponentException(
                                        "Error while decoding sipToPermission: Parameter bad tag or tag class or not " +
                                                "primitive",
                                        MAPParsingComponentExceptionReason.MistypedParameter);
                        ...
                        case _ID_lipa_Permission:
                            if (!ais.isTagPrimitive())
                                throw new MAPParsingComponentException(
                                        "Error while decoding lipaPermission: Parameter bad tag or tag class or not " +
                                                "primitive",
                                        MAPParsingComponentExceptionReason.MistypedParameter);
        ...
        {
            throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                    + ": A mandatory parameter ContextId has not found", MAPParsingComponentExceptionReason
                    .MistypedParameter);
        }
        if (this.pdpType == null)
        {
            ...
            throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                    + ": A mandatory parameter pdpType has not found", MAPParsingComponentExceptionReason
                    .MistypedParameter);
        }
        ...
        {
            throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                    + ": A mandatory parameter apn has not found", MAPParsingComponentExceptionReason
                    .MistypedParameter);
        }
    }
