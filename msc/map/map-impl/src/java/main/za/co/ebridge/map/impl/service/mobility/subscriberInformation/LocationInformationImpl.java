        ...
        implements LocationInformation
{
    ...
    public LocationInformationImpl(
            Integer ageOfLocationInformation, GeographicalInformation geographicalInformation,
            ...
            } else if (ais.getTagClass() == Tag.CLASS_CONTEXT_SPECIFIC)
            {
                ...
                switch (tag)
                {
                    ...
                    case _ID_cellGlobalIdOrServiceAreaIdOrLAI:
                        ...
                        // ais2.readTag();
                        // ((CellGlobalIdOrServiceAreaIdOrLAIImpl) this.cellGlobalIdOrServiceAreaIdOrLAI).decodeAll
                        // (ais2);
                        break;
     ...
     */
    protected static final XMLFormat<LocationInformationImpl> LOCATION_INFORMATION_XML = new
            XMLFormat<LocationInformationImpl>()
    {
                ...
                XMLStreamException
        {
            ...
            locationInformation.locationInformationEPS = xml.get(LOCATION_INFORMATION_EPS, LocationInformationEPSImpl
                    .class);
                ...
                XMLStreamException
        {
            ...
            {
                xml.add((Integer) locationInformation.ageOfLocationInformation, AGE_OF_LOCATION_INFORMATION, Integer
                        .class);
            }
