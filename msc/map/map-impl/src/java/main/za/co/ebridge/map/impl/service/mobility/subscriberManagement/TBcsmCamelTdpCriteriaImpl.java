...
public class TBcsmCamelTdpCriteriaImpl
        ...
        implements TBcsmCamelTdpCriteria
{
                        ...
                        case _TAG_tCauseValueCriteria:
                            ...
                            if (this.tCauseValueCriteria.size() < 1 || this.tCauseValueCriteria.size() > 5)
                            {
                                throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                                        ...
                                        + this.tCauseValueCriteria.size(), MAPParsingComponentExceptionReason
                                        .MistypedParameter);
                            }
                            break;
                        default:
            ...
            MAPException
    {
        ...
        if (this.tCauseValueCriteria != null && (this.tCauseValueCriteria.size() < 1 || this.tCauseValueCriteria.size
                () > 5))
        {
            throw new MAPException("Error while encoding " + _PrimitiveName
                    + ": Parameter tCauseValueCriteria size must be from 1 to 5, found: " + this.tCauseValueCriteria
                    .size());
        }
