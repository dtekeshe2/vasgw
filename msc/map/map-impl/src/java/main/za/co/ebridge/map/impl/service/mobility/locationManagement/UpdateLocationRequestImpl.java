        ...
        implements UpdateLocationRequest
{
                    ...
                    if (ais.getTagClass() != Tag.CLASS_CONTEXT_SPECIFIC || !ais.isTagPrimitive()
                        ...
                        throw new MAPParsingComponentException(
                                "Error while decoding "
                                        + _PrimitiveName
                                        + ".mscNumber or roamingNumber: Parameter 1 bad tag class or tag or not " +
                                        "primitive or unsupported in the incoming message version",
                                MAPParsingComponentExceptionReason.MistypedParameter);
            ...
            MAPException
    {
        ...
        try
        {
            if (this.imsi == null || (this.mscNumber == null && (this.roamingNumber == null || this
            ...
            if (this.mscNumber != null)
                ...
                ((ISDNAddressStringImpl) this.roamingNumber).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                        _TAG_roamingNumber);
            ...
            if (this.vlrCapability != null)
                ((VLRCapabilityImpl) this.vlrCapability).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                        _TAG_vlrCapability);
