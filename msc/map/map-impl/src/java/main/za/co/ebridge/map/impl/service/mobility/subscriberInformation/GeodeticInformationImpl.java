        ...
        implements GeodeticInformation
{
    ...
    public GeodeticInformationImpl(
            int screeningAndPresentationIndicators, TypeOfShape typeOfShape, double latitude,
    ...
    public void setData(
            int screeningAndPresentationIndicators, TypeOfShape typeOfShape, double latitude, double longitude,
            double uncertainty, int confidence)
            throws
            MAPException
    {
        ...
        if (typeOfShape != TypeOfShape.EllipsoidPointWithUncertaintyCircle)
        {
            throw new MAPException(
                    "typeOfShape parameter for GeographicalInformation can be only \" ellipsoid point with " +
                            "uncertainty circle\"");
        }
     ...
     */
    protected static final XMLFormat<GeodeticInformationImpl> GEODETIC_INFORMATION_XML = new
            XMLFormat<GeodeticInformationImpl>()
    {
        ...
        public void write(GeodeticInformationImpl geodeticInformation, javolution.xml.XMLFormat.OutputElement xml)
                ...
                XMLStreamException
        {
            xml.setAttribute(SCREENING_AND_PRESENTATION_INDICATORS, geodeticInformation
