        ...
        implements OCSI
{
            ...
            AsnException
    {
                ...
                case 0:
                    ...
                    while (true)
                    {
                        ...
                        if (this.oBcsmCamelTDPDataList.size() < 1 || this.oBcsmCamelTDPDataList.size() > 10)
                            throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                                    + ".oBcsmCamelTDPDataList: tBcsmCamelTDPData elements count must be from 1 to 10," +
                                    " found: "
                                    + this.oBcsmCamelTDPDataList.size(), MAPParsingComponentExceptionReason
                                    .MistypedParameter);
                    }
                    break;
        ...
        {
            throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                    + ": Parament oBcsmCamelTDPDataList is mandatory but does not found",
                    MAPParsingComponentExceptionReason.MistypedParameter);
        }
    }
            ...
            MAPException
    {
        try
        {
            if (this.oBcsmCamelTDPDataList == null)
                throw new MAPException("Error while encoding" + _PrimitiveName + ": oBcsmCamelTDPDataList must not be" +
                        " null");
            if (this.oBcsmCamelTDPDataList.size() < 1 || this.oBcsmCamelTDPDataList.size() > 10)
                throw new MAPException("Error while encoding" + _PrimitiveName
                        + ": oBcsmCamelTDPDataList size must be from 1 to 10, found: " + this.oBcsmCamelTDPDataList
                        .size());
            ...
            if (this.camelCapabilityHandling != null)
                asnOs.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _TAGcamelCapabilityHandling, this
