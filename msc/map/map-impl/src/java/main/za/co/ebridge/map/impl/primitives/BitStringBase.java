        ...
        implements MAPAsnPrimitive
{
     ...
     */
    protected static final XMLFormat<BitStringBase> BIT_STRING_BASE_XML = new XMLFormat<BitStringBase>()
    {

        @Override
        public void read(javolution.xml.XMLFormat.InputElement xml, BitStringBase bitStringBase)
                throws
                XMLStreamException
        {
        ...
        @Override
        public void write(BitStringBase bitStringBase, javolution.xml.XMLFormat.OutputElement xml)
                throws
                XMLStreamException
        {
