...
import za.co.ebridge.map.api.service.lsm.ProvideSubscriberLocationResponse;
...
public class ProvideSubscriberLocationResponseImpl extends LsmMessageImpl implements ProvideSubscriberLocationResponse {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm. ProvideSubscriberLocationResponseIndication#getLocationEstimate()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm. ProvideSubscriberLocationResponseIndication
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm. ProvideSubscriberLocationResponseIndication#getExtensionContainer()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm. ProvideSubscriberLocationResponseIndication#getSaiPresent()
     */
