...
public class SmsDeliverTpduImpl
        extends SmsTpduImpl
        implements SmsDeliverTpdu
{
    ...
    public SmsDeliverTpduImpl(byte[] data, Charset gsm8Charset)
            throws
            MAPException
    {
        this();
        ...
        {
            throw new MAPException("IOException while creating a new SmsDeliverTpduImpl instance: " + e.getMessage(),
                    e);
        }
            ...
            MAPException
    {
        ...
        if (this.originatingAddress == null || this.protocolIdentifier == null || this.serviceCentreTimeStamp == null
                || this.userData == null)
            throw new MAPException(
                    "Parameters originatingAddress, protocolIdentifier, serviceCentreTimeStamp and userData must not " +
                            "be null");
        ...
        res.write(SmsTpduType.SMS_DELIVER.getEncodedValue() | (!this.moreMessagesToSend ? _MASK_TP_MMS : 0)
                ...
                | (this.userDataHeaderIndicator ? _MASK_TP_UDHI : 0) | (this.statusReportIndication ? _MASK_TP_SRI :
                0));
