        ...
        implements SMSCSI
{
                        ...
                        case _TAG_smsCamelTdpDataList:
                            ...
                            if (this.smsCamelTdpDataList.size() < 1 || this.smsCamelTdpDataList.size() > 1)
                            {
                                throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                                        ...
                                        + this.smsCamelTdpDataList.size(), MAPParsingComponentExceptionReason
                                        .MistypedParameter);
                            }
                            break;
            ...
            MAPException
    {
        ...
        if (this.smsCamelTdpDataList != null && (this.smsCamelTdpDataList.size() < 1 || this.smsCamelTdpDataList.size
                () > 10))
        {
            throw new MAPException("Error while encoding " + _PrimitiveName
                    + ": Parameter smsCamelTdpDataList size must be from 1 to 10, found: " + this.smsCamelTdpDataList
                    .size());
        }
        ...
        try
        {
            ...
            if (this.camelCapabilityHandling != null)
                asnOs.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_camelCapabilityHandling, this
