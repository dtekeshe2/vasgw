...
public class UserCSGInformationImpl
        implements UserCSGInformation, MAPAsnPrimitive
{
            ...
            if (ais.getTagClass() == Tag.CLASS_CONTEXT_SPECIFIC)
            {
                ...
                switch (tag)
                {
                    ...
                    case _ID_cmi:
                        if (!ais.isTagPrimitive())
                            throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                                    + " cmi: Parameter is not primitive", MAPParsingComponentExceptionReason
                                    .MistypedParameter);
     ...
     */
    protected static final XMLFormat<UserCSGInformationImpl> USER_CSG_INFORMATION_XML = new
            XMLFormat<UserCSGInformationImpl>()
    {
