        ...
        implements LCSPrivacyClass
{
    ...
    public LCSPrivacyClassImpl(
            SSCode ssCode, ExtSSStatus ssStatus, NotificationToMSUser notificationToMSUser,
                            ...
                            switch (tag)
                            {
                                    ...
                                    while (true)
                                    {
                                        ...
                                        if (tag2 != Tag.SEQUENCE || ais2.getTagClass() != Tag.CLASS_UNIVERSAL
                                            ...
                                            throw new MAPParsingComponentException("Error while decoding " +
                                                    _PrimitiveName
                                                    + ": bad tag or tagClass or is primitive when decoding " +
                                                    "externalClientList",
                                                    MAPParsingComponentExceptionReason.MistypedParameter);
                                ...
                                case _TAG_plmnClientList:
                                    ...
                                    while (true)
                                    {
                                        ...
                                        if (tag2 != Tag.INTEGER || ais3.getTagClass() != Tag.CLASS_UNIVERSAL
                                            ...
                                            throw new MAPParsingComponentException("Error while decoding " +
                                                    _PrimitiveName
                                                    + ": bad tag or tagClass or is not primitive when decoding " +
                                                    "plmnClientList",
                                                    MAPParsingComponentExceptionReason.MistypedParameter);
                                ...
                                case _TAG_extExternalClientList:
                                    ...
                                    while (true)
                                    {
                                        ...
                                        if (this.extExternalClientList.size() < 1 || this.extExternalClientList.size
                                                () > 35)
                                            throw new MAPParsingComponentException("Error while decoding " +
                                                    _PrimitiveName
                                                    + ".extExternalClientList: elements count must be from 1 to 35, " +
                                                    "found: "
            ...
            MAPException
    {
        ...
        if (this.externalClientList != null && (this.externalClientList.size() < 0 || this.externalClientList.size()
                > 5))
        {
            throw new MAPException("Error while encoding " + _PrimitiveName
                    + ": Parameter externalClientList size must be from 1 to 5, found: " + this.externalClientList
                    .size());
        }
