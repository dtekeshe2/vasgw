...
import za.co.ebridge.map.api.service.sms.InformServiceCentreRequest;
        ...
        implements InformServiceCentreRequest
{
            ...
            MAPParsingComponentException
    {
        ...
        {
            throw new MAPParsingComponentException("IOException when decoding InformServiceCentreRequest: " + e
                    .getMessage(),
                    e, MAPParsingComponentExceptionReason.MistypedParameter);
        }
        catch (AsnException e)
        {
            throw new MAPParsingComponentException("AsnException when decoding InformServiceCentreRequest: " + e
                    .getMessage(),
                    e, MAPParsingComponentExceptionReason.MistypedParameter);
        }
    }
            ...
            if (ais.getTagClass() == Tag.CLASS_UNIVERSAL)
            {
                ...
                switch (tag)
                {
                    case Tag.STRING_OCTET:
                        ...
                        if (!ais.isTagPrimitive())
                            throw new MAPParsingComponentException(
                                    "Error while decoding informServiceCentreRequest: Parameter storedMSISDN is not " +
                                            "primitive",
                    ...
                    case Tag.STRING_BIT:
                        ...
                        if (!ais.isTagPrimitive())
                            throw new MAPParsingComponentException(
                                    "Error while decoding informServiceCentreRequest: Parameter mw-Status is not " +
                                            "primitive",
                                    MAPParsingComponentExceptionReason.MistypedParameter);
                    ...
                    case Tag.SEQUENCE:
                        ...
                        if (ais.isTagPrimitive())
                            throw new MAPParsingComponentException(
                                    "Error while decoding reportSMDeliveryStatusRequest: Parameter extensionContainer" +
                                            " is primitive",
                                    MAPParsingComponentExceptionReason.MistypedParameter);
                    ...
                    case Tag.INTEGER:
                        ...
                        if (!ais.isTagPrimitive())
                            throw new MAPParsingComponentException(
                                    "Error while decoding informServiceCentreRequest: Parameter " +
                                            "absentSubscriberDiagnosticSM is not primitive",
                                    MAPParsingComponentExceptionReason.MistypedParameter);
                ...
                switch (tag)
                {
                    case InformServiceCentreRequestImpl._TAG_AdditionalAbsentSubscriberDiagnosticSM:
                        ...
                        if (!ais.isTagPrimitive())
                            throw new MAPParsingComponentException(
                                    "Error while decoding informServiceCentreRequest: Parameter " +
                                            "deliveryOutcomeIndicator is not primitive",
                                    MAPParsingComponentExceptionReason.MistypedParameter);
