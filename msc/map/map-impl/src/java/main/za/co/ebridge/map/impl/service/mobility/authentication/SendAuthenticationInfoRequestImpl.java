        ...
        } else
        {
            try
            {
                ...
                if (requestingNodeType != null)
                    asnOs.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_requestingNodeType, requestingNodeType
                            .getCode());
                if (this.requestingPlmnId != null)
                    ((PlmnIdImpl) this.requestingPlmnId).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                            _TAG_requestingPLMNId);
