        ...
        implements DestinationNumberCriteria
{
    ...
    public DestinationNumberCriteriaImpl(
            MatchType matchType, ArrayList<ISDNAddressString> destinationNumberList,
                    ...
                    switch (tag)
                    {
                        ...
                        case _TAG_destinationNumberLengthList:
                            ...
                            while (true)
                            {
                                ...
                                if (tag3 != Tag.INTEGER || ais3.getTagClass() != Tag.CLASS_UNIVERSAL || !ais3
                                        .isTagPrimitive())
                            ...
                            if (this.destinationNumberLengthList.size() < 1 && this.destinationNumberLengthList.size
                                    () > 3)
                            {
                                throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
            ...
            MAPException
    {
        ...
        if (this.destinationNumberList == null && this.destinationNumberLengthList == null)
        {
            throw new MAPException("Error while encoding " + _PrimitiveName + ". one or both of destinationNumberList" +
                    " and "
