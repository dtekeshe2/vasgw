        ...
        implements LocationInformationGPRS
{
    ...
    public static CellGlobalIdOrServiceAreaIdOrLAI decodeCellGlobalIdOrServiceAreaIdOrLAI(
            AsnInputStream ais,
            ...
            IOException
    {
        if (ais.isTagPrimitive())
        {
            ...
            if (len == 7)
            {
                ...
                CellGlobalIdOrServiceAreaIdOrLAI cellGlobalIdOrServiceAreaIdOrLAI = new
            ...
            if (ais.getTagClass() == Tag.CLASS_CONTEXT_SPECIFIC)
            {
                ...
                switch (tag)
                {
                    case _ID_cellGlobalIdOrServiceAreaIdOrLAI:
                        this.cellGlobalIdOrServiceAreaIdOrLAI = decodeCellGlobalIdOrServiceAreaIdOrLAI(ais,
                                _PrimitiveName);
                        break;
            ...
            if (this.saiPresent)
            {
                ...
                catch (IOException e)
                {
                    throw new MAPException(
                            "Error while encoding LocationInformation the optional parameter sai-Present encoding " +
                                    "failed ", e);
                }
