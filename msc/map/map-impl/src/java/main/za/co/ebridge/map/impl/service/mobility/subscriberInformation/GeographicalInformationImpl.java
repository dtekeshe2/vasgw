        ...
        implements GeographicalInformation
{
            ...
            MAPException
    {
        if (typeOfShape != TypeOfShape.EllipsoidPointWithUncertaintyCircle)
        {
            throw new MAPException(
                    "typeOfShape parameter for GeographicalInformation can be only \"ellipsoid point with uncertainty" +
                            " circle\"");
        }
     ...
     */
    protected static final XMLFormat<GeographicalInformationImpl> GEOGRAPHICAL_INFORMATION_XML = new
            XMLFormat<GeographicalInformationImpl>()
    {
        ...
        @Override
        public void write(
                GeographicalInformationImpl geographicalInformation,
