...
import za.co.ebridge.map.api.primitives.AlertingCategory;
import za.co.ebridge.map.api.primitives.AlertingLevel;
...
public class AlertingPatternImpl extends OctetStringLength1Base implements AlertingPattern {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.primitives.AlertingPattern# getAlertingLevel()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.primitives.AlertingPattern# getAlertingCategory()
     */
