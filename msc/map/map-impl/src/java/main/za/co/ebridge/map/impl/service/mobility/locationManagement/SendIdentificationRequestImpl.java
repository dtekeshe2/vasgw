        ...
        implements SendIdentificationRequest
{
    ...
    public SendIdentificationRequestImpl(
            ...
            MAPException
    {
        ...
        if (this.tmsi == null)
        {
            throw new MAPException("Error while encoding " + _PrimitiveName + " the mandatory parameter tmsi is not " +
                    "defined");
        }
        ...
        try
        {
            if (mapProtocolVersion >= 3)
            {
                ...
                if (this.previousLAI != null)
                    ((LAIFixedLengthImpl) this.previousLAI).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                            _TAG_previousLAI);
                ...
                if (this.newVLRNumber != null)
                    ((ISDNAddressStringImpl) this.newVLRNumber).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                            _TAG_newVLRNumber);
