...
public class ExtBearerServiceCodeImpl
        extends OctetStringBase
        implements ExtBearerServiceCode
{
     ...
     */
    protected static final XMLFormat<ExtBearerServiceCodeImpl> EXT_BEARER_SERVICE_CODE_XML = new
            XMLFormat<ExtBearerServiceCodeImpl>()
    {
