...
public class SmsStatusReportTpduImpl
        extends SmsTpduImpl
        implements SmsStatusReportTpdu
{
    ...
    public SmsStatusReportTpduImpl(
    ...
    public SmsStatusReportTpduImpl(byte[] data, Charset gsm8Charset)
            throws
            MAPException
    {
        this();
        ...
        if (this.messageReference == -1)
            throw new MAPException("Error creating a new SmsStatusReport instance: messageReference field has not " +
                    "been found");
        ...
        if (this.parameterIndicator.getTP_UDLPresence())
        {
            ...
            if (this.userDataLength == -1)
                throw new MAPException("Error creating a new SmsStatusReport instance: userDataLength field has not " +
                        "been found");
            ...
            {
                throw new MAPException("IOException while creating a new SmsStatusReport instance: " + e.getMessage()
                        , e);
            }
            ...
            MAPException
    {
        ...
        if (statusReportQualifier == null || this.recipientAddress == null || this.serviceCentreTimeStamp == null
            ...
            throw new MAPException(
                    "Error encoding a SmsStatusReportTpdu: statusReportQualifier, recipientAddress, " +
                            "serviceCentreTimeStamp, dischargeTime and status must no be null");
