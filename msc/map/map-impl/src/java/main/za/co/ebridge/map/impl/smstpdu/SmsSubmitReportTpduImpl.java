...
public class SmsSubmitReportTpduImpl
        extends SmsTpduImpl
        implements SmsSubmitReportTpdu
{
    ...
    public SmsSubmitReportTpduImpl(
    ...
    public SmsSubmitReportTpduImpl(byte[] data, Charset gsm8Charset)
            throws
            MAPException
    {
        this();
