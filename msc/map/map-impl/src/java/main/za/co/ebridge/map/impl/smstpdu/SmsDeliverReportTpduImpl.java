...
public class SmsDeliverReportTpduImpl
        extends SmsTpduImpl
        implements SmsDeliverReportTpdu
{
    ...
    public SmsDeliverReportTpduImpl(byte[] data, Charset gsm8Charset)
            throws
            MAPException
    {
        this();
        ...
        if (bt == -1)
            throw new MAPException(
                    "Error creating a new SmsDeliverReportTpdu instance: Failure-Cause and Parameter-Indicator fields" +
                            " have not been found");
        if ((bt & 0x80) != 0)
        {
            ...
            if (bt == -1)
                throw new MAPException(
                        "Error creating a new SmsDeliverReportTpdu instance: Parameter-Indicator field has not been " +
                                "found");
        }
        ...
        if (this.parameterIndicator.getTP_PIDPresence())
        {
            ...
            if (bt == -1)
                throw new MAPException(
                        "Error creating a new SmsDeliverTpduImpl instance: protocolIdentifier field has not been " +
                                "found");
        ...
        if (this.parameterIndicator.getTP_UDLPresence())
        {
            ...
            {
                throw new MAPException("IOException while creating a new SmsDeliverTpduImpl instance: " + e
                        .getMessage(), e);
            }
            ...
            MAPException
    {
        ...
        // byte 0
        res.write(SmsTpduType.SMS_DELIVER_REPORT.getEncodedValue() | (this.userDataHeaderIndicator ? _MASK_TP_UDHI :
                0));
