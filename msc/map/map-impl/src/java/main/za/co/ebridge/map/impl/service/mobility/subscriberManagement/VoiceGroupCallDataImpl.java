        ...
        implements VoiceGroupCallData
{
            ...
            MAPException
    {
        ...
        if (this.additionalSubscriptions != null)
            ((AdditionalSubscriptionsImpl) this.additionalSubscriptions).encodeAll(asnOs, Tag.CLASS_UNIVERSAL, Tag
                    .STRING_BIT);

        if (this.additionalInfo != null)
            ((AdditionalInfoImpl) this.additionalInfo).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                    _TAG_additionalInfo);
