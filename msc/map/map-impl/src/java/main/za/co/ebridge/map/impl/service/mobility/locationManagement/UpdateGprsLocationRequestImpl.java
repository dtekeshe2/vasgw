        ...
        implements UpdateGprsLocationRequest
{
            ...
            AsnException
    {
        ...
        if (this.imsi == null || this.sgsnNumber == null || this.sgsnAddress == null)
            throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                    + ": imsi or sgsnNumber or sgsnAddress is null ", MAPParsingComponentExceptionReason
                    .MistypedParameter);
            ...
            MAPException
    {
        ...
        try
        {
            ...
            if (this.sgsnCapability != null)
                ((SGSNCapabilityImpl) this.sgsnCapability).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                        TAG_sgsnCapability);
