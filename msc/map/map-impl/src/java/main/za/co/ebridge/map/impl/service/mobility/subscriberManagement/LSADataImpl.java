        ...
        implements LSAData
{
            ...
            AsnException
    {
        ...
        while (true)
        {
            ...
            {
                case 0:
                    if (tag != _TAG_lsaIdentity || ais.getTagClass() != Tag.CLASS_CONTEXT_SPECIFIC || !ais
                            .isTagPrimitive())
                    ...
                    break;
                case 1:
                    if (tag != _TAG_lsaAttributes || ais.getTagClass() != Tag.CLASS_CONTEXT_SPECIFIC || !ais
                            .isTagPrimitive())
                        throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
