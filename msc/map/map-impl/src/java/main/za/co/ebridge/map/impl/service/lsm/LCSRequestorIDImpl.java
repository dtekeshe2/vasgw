...
public class LCSRequestorIDImpl implements LCSRequestorID, MAPAsnPrimitive {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm.LCSRequestorID# getDataCodingScheme()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm.LCSRequestorID# getRequestorIDString()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm.LCSRequestorID# getLCSFormatIndicator()
     */
