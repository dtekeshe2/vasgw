...
public class SubscriberIdentityImpl implements SubscriberIdentity, MAPAsnPrimitive {
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm.SubscriberIdentity#getIMSI ()
     */
    public IMSI getIMSI() {
        return this.imsi;
    }
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm.SubscriberIdentity#getMSISDN ()
     */
