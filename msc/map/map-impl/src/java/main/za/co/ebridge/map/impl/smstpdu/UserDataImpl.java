...
import za.co.ebridge.map.api.smstpdu.ConcatenatedMessage;
...
import za.co.ebridge.map.impl.GSMCharsetEncodingData;
        ...
        implements UserData
{
    ...
    public UserDataImpl(
            String decodedMessage, DataCodingScheme dataCodingScheme, UserDataHeader decodedUserDataHeader,
            Charset gsm8Charset)
    {
                ...
                case GSM7:
                    ...
                    if (this.decodedUserDataHeader != null)
                    {
                        ...
                        if (nationalLanguageSingleShift != null)
                            nationalLanguageSingleShiftIdentifier = nationalLanguageSingleShift
                                    .getNationalLanguageIdentifier();
                    }
                ...
                case GSM8:
                    ...
                    } else
                    {
                        throw new MAPException(
                                "Error encoding a text in Sms UserData: gsm8Charset is not defined for GSM8 " +
                                        "dataCodingScheme");
                    }
                    break;
            ...
            switch (this.dataCodingScheme.getCharacterSet())
            {
                case GSM7:
                    ...
                    if (offset > 0)
                    {
                        ...
                        decoder.setGSMCharsetDecodingData(new GSMCharsetDecodingData(this.encodedUserDataLength,
                                septetOffset));
                    } else
    ...
    public static UserData[] encodeSplitedMessagesSet(
            ...
            UserDataHeaderElement[] extraUserDataHeader)
            throws
            MAPException
    {
    ...
    public static ConcatenatedMessage decodeSplittedMessagesSet(
            UserData[] encodedArray,
