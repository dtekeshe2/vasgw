        ...
        implements LCSInformation
{
    ...
    public LCSInformationImpl(
            ArrayList<ISDNAddressString> gmlcList, ArrayList<LCSPrivacyClass> lcsPrivacyExceptionList,
                ...
                case Tag.CLASS_CONTEXT_SPECIFIC:
                {
                    switch (tag)
                    {
                        case _TAG_gmlcList:
                            ...
                            {
                                throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                                        + ": Parameter gmlcList size must be from 1 to 5, found: " + this.gmlcList
                                        .size(),
                                        MAPParsingComponentExceptionReason.MistypedParameter);
                            }
                            break;
                        case _TAG_lcsPrivacyExceptionList:
                            ...
                            while (true)
                            {
                                ...
                                if (tag2 != Tag.SEQUENCE || ais3.getTagClass() != Tag.CLASS_UNIVERSAL || ais3
                                        .isTagPrimitive())
                                    throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                        ...
                        case _TAG_molrList:
                            ...
                            while (true)
                            {
                                ...
                                if (tag2 != Tag.SEQUENCE || ais4.getTagClass() != Tag.CLASS_UNIVERSAL || ais4
                                        .isTagPrimitive())
                                    throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                            ...
                            {
                                throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                                        + ": Parameter molrList size must be from 1 to 3, found: " + this.molrList
                                        .size(),
                                        MAPParsingComponentExceptionReason.MistypedParameter);
                            }
                            break;
                        case _TAG_addLcsPrivacyExceptionList:
                            ...
                            while (true)
                            {
                                ...
                                if (tag2 != Tag.SEQUENCE || ais5.getTagClass() != Tag.CLASS_UNIVERSAL || ais5
                                        .isTagPrimitive())
                                    throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
                            ...
                            if (this.addLcsPrivacyExceptionList.size() < 1 || this.addLcsPrivacyExceptionList.size()
                                    > 4)
                            {
                                throw new MAPParsingComponentException("Error while decoding " + _PrimitiveName
