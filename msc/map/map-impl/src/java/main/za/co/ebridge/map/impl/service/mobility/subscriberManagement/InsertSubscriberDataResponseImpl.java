        ...
        implements InsertSubscriberDataResponse
{
    ...
    public InsertSubscriberDataResponseImpl(
            long mapProtocolVersion, ArrayList<ExtTeleserviceCode> teleserviceList,
            ...
            MAPException
    {
        ...
        if (this.teleserviceList != null)
        {
            ...
            {
                throw new MAPException("AsnException when encoding " + _PrimitiveName + ".teleserviceList: " + e
                        .getMessage(),
                        e);
            }
        }
        ...
        if (this.ssList != null)
        {
            ...
            {
                throw new MAPException("AsnException when encoding " + _PrimitiveName + ".ssList: " + e.getMessage(),
                        e);
            }
        }
        if (this.odbGeneralData != null)
        {
            ((ODBGeneralDataImpl) this.odbGeneralData).encodeAll(asnOs, Tag.CLASS_CONTEXT_SPECIFIC,
                    _TAG_odb_GeneralData);
        }
