        ...
        implements SupportedLCSCapabilitySets, MAPAsnPrimitive
{
    ...
    public SupportedLCSCapabilitySetsImpl(
            boolean lcsCapabilitySetRelease98_99, boolean lcsCapabilitySetRelease4,
     ...
     * (non-Javadoc)
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.primitives.MAPAsnPrimitive#decodeAll(com.ebridge
     ...
     *
     * @see
     * org.mobicents.protocols.protocols.ss7.cap.api.map.api.primitives.MAPAsnPrimitive#decodeData(com.ebridge
     * .protocols.asn.AsnInputStream,
     * int)
     */
            ...
            AsnException
    {
        if (length < 1 || length > 3)
            throw new MAPParsingComponentException(
                    "Error decoding SupportedLCSCapabilitySets: the SupportedLCSCapabilitySets field must contain " +
                            "from 1 or 3 octets. Contains: "
     ...
     *
     * @see
     * org.mobicents.protocols.protocols.ss7.cap.api.map.api.primitives.MAPAsnPrimitive#encodeAll(com.ebridge
     ...
     *
     * @see
     * org.mobicents.protocols.protocols.ss7.cap.api.map.api.primitives.MAPAsnPrimitive#encodeData(com.ebridge
     * .protocols.asn.AsnOutputStream)
     */
     ...
     * .SupportedLCSCapabilitySets#getLcsCapabilitySet1()
     */
     ...
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm
     * .SupportedLCSCapabilitySets#getLcsCapabilitySet2()
     */
     ...
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm
     * .SupportedLCSCapabilitySets#getLcsCapabilitySet3()
     */
     ...
     *
     * @see org.mobicents.protocols.protocols.ss7.cap.api.map.api.service.lsm
     * .SupportedLCSCapabilitySets#getLcsCapabilitySet4()
     */
